...
def main():
    ...
    print(main_bezel(width = bezel_width, height = bezel_height, stroke_width = 3))

    # Pots and buttons under the CRT.
    first_pot = 4.41 + 6.2 + 5
    pot_space = 30.3
    print(pot(x = first_pot + 0 * pot_space, y = 134, name = "INTENSITY"))
    print(pot(x = first_pot + 1 * pot_space, y = 134, name = "FOCUS"))
    print(pot(x = first_pot + 2 * pot_space, y = 134, name = "READOUT INTENSITY"))
    print(pot(x = first_pot + 3 * pot_space, y = 134, name = "SCALE ILLUM"))
    ...
    # CH1 POS
    print(pot(x = first_pot + 0 * pot_space, y = 20, name = "POSITION"))
    # CH2 POS
    print(pot(x = first_pot + 1 * pot_space, y = 20, name = "POSITION"))
    # VERT POS
    vert_pos_x = first_pot + 2 * pot_space
    print(pot(x = vert_pos_x, y = 20, name = "POSITION"))
    but(x = vert_pos_x + 16, y = 20, name = "X10 MAG")

    print(pot(x = first_pot + 88, y = 20, name = "HOLDOFF"))
    print(pot(x = first_pot + 120, y = 20, name = "LEVEL"))
    ...
    row_y = 52
    print(pot(x = bezel_edge + 72, y = row_y, name = "D REF or DLY POS"))
    print(pot(x = bezel_edge + 72 + 22.3, y = row_y, name = "D"))

    btn_width = 18.1
    first_but = bezel_edge + 7.5 + btn_width / 2
    row_y = 87.1 - btn_width / 2
    print(volts_div(x = first_but, y = row_y))
    print(volts_div(x = first_but + 31.6, y = row_y))

    print(sec_div(x = first_but + 86.5 - btn_width / 2 - 21.5 / 2, y = row_y))
    ...
    print(pot(x = bezel_edge + 72, y = row_y, name = "TRACE\nSEP"))
    # CH3 POS
    print(pot(x = bezel_edge + 96, y = row_y, name = "POSITION"))

    but(x = bezel_edge + 111, y = row_y, name = "VOLTS/DIV")
    but(x = bezel_edge + 121, y = row_y, name = "VOLTS/DIV")

    # CH4 POS
    print(pot(x = bezel_edge + 139, y = row_y, name = "POSITION"))

    row_y = 130
    print(bnc(x = bezel_edge + 16, y = row_y, name = "CH 1"))
    print(bnc(x = bezel_edge + 58, y = row_y, name = "CH 2"))
    print(bnc(x = bezel_edge + 95, y = row_y, name = "CH 3"))
    print(bnc(x = bezel_edge + 139, y = row_y, name = "CH 4"))
